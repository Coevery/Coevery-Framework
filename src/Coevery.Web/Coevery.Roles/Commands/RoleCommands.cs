...
namespace Coevery.Roles.Commands {
    public class RoleCommands : DefaultCoeveryCommandHandler {
        ...
        [CoeverySwitches("WithFeature,WithPermission,IncludeUsers,IncludePermissions")]
