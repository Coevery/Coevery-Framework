(function ($) {
    $.fn.extend({
        powerUpTheSwitch: function () {
            ...
            var setting = $.Coevery.setting("switchable", { path: document.location.pathname })
        ...
        switchToDetailView: function (switched) {
            $.Coevery.setting("switchable", "detail-view", { path: document.location.pathname });
        ...
        switchToSummaryView: function (switched) {
            $.Coevery.setting("switchable", "summary-view", { path: document.location.pathname });
