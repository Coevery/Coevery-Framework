...
namespace Coevery.Tests.Environment {
    ...
    public class DefaultCompositionStrategyTests {
        ...
        public void RecordsArePutIntoBlueprintWithTableName() {
            ...
            Assert.That(foo.TableName, Is.EqualTo("FooRecord"));

            Assert.That(bar.Feature.Descriptor.Id, Is.EqualTo("Bar"));
            Assert.That(bar.TableName, Is.EqualTo("BarRecord"));
        }
        ...
        public void CoreRecordsAreAddedAutomatically() {
            ...
            Assert.That(ct.TableName, Is.EqualTo("ContentTypeRecord"));

            Assert.That(ci.Feature.Descriptor.Id, Is.EqualTo("Coevery.Framework"));
            Assert.That(ci.TableName, Is.EqualTo("ContentItemRecord"));

            Assert.That(civ.Feature.Descriptor.Id, Is.EqualTo("Coevery.Framework"));
            Assert.That(civ.TableName, Is.EqualTo("ContentItemVersionRecord"));
        }
        ...
        public void DataPrefixChangesTableName() {
            ...
            Assert.That(foo.Feature.Descriptor.Id, Is.EqualTo("Foo Plus"));
            Assert.That(foo.TableName, Is.EqualTo("Yadda_FooRecord"));

            Assert.That(bar.Feature.Descriptor.Id, Is.EqualTo("Bar"));
            Assert.That(bar.TableName, Is.EqualTo("Yadda_BarRecord"));
        }
