...
namespace Coevery.WebApi {
    public class DefaultCoeveryWebApiHttpHttpControllerActivator : IHttpControllerActivator {
        private readonly HttpConfiguration _configuration;

        public DefaultCoeveryWebApiHttpHttpControllerActivator(HttpConfiguration configuration) : base() {
