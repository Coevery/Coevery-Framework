...
using Coevery.WebApi.Extensions;

namespace Coevery.WebApi {
    public class DefaultCoeveryWebApiHttpControllerSelector : DefaultHttpControllerSelector, IHttpControllerSelector {
        private readonly HttpConfiguration _configuration;

        public DefaultCoeveryWebApiHttpControllerSelector(HttpConfiguration configuration) : base(configuration) {
