        ...
        private void CompileViews(object sender, ElapsedEventArgs elapsedEventArgs) {
            ...
            var context = new CompilationContext {
                ...
                DirectoriesToBrowse = new[] {
                    ...
                    // Content Items
                    "~/Modules/Coevery.PublishLater/Views",

                    // Content Types
                    "~/Modules/Coevery.ContentTypes/Views",

                    // "Edit" homepage
                    "~/Modules/TinyMce/Views",
                    "~/Modules/Coevery.Tags/Views",
                    "~/Core/Navigation/Views",

                    // Various other admin pages
                    "~/Core/Settings/Views",
                    "~/Core/Containers/Views",
                    "~/Modules/Coevery.Widgets/Views",
                    "~/Modules/Coevery.Users/Views",
                    "~/Modules/Coevery.MediaLibrary/Views",
                    "~/Modules/Coevery.Comments/Views",
